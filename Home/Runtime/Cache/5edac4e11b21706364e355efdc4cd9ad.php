        ...
        <div id="con">
            <div id="con_l">
                <div id="box">
                 ...
                 <div id="con_m">
                <div id="title">
                    您的位置：首页<span>></span>网上互动<span>></span><?php echo ($type); ?><span>></span><?php echo ($content["art_title"]); ?>
                </div>
                <div id="passage">
                    <h1><?php echo ($content["art_title"]); ?></h1><br />
                    <div class="contents">
                        <p style="text-align:center;"><?php echo ($ann_show); ?><p/><br />
...
<script src="__JS__/height.js"></script>
<script>
    $(".num5").addClass("hover");
</script>
</body>
