	...
	<div id="wrap">
        ...
        <div id="con">
            <div id="con_l">
                <div id="box">
                    <ul id="list">
                        <li class="list"><a href="http://office.cqupt.edu.cn/mail.php">书记校长信箱</a></li>
                        
						<li class="list"><a href="__APP__/Interaction/index/tid/6">网上公示</a></li>
						
                        
						<li class="list"><a href="__APP__/Interaction/index/tid/7">最新规章制度</a></li>
            ...
            <div id="con_m">
                <div id="title">
                    您的位置：首页<span>></span>网上互动<span>></span><?php echo ($type); ?>
                </div>
                <ul class="article">
                   <?php if(is_array($guide)): foreach($guide as $key=>$gu): ?><li class="article_l"><a href="__APP__/Interaction/detail/type/<?php echo ($gu["art_type"]); ?>/aid/<?php echo ($gu["art_id"]); ?>"><?php echo ($gu["art_title"]); ?></a></li><?php endforeach; endif; ?>
                </ul>
            ...
            <ul >
			  ...
			  <!---
                ...
                <li>页</li>
                <li><a href="#"><img src="__IMG__/sure.gif"></a></li>
				--->
            </ul>
			    </div>
			</div>
