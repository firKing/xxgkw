	...
	<div id="wrap">
        ...
        <div id="con">
            <div id="con_l">
                <div id="box">
                    <ul id="list">
                    <?php if(is_array($np_list)): foreach($np_list as $key=>$np): ?><li class="list"><a href="__APP__/Menu/index/aid/<?php echo ($np["art_id"]); ?>"><?php echo ($np["art_title"]); ?></a></li><?php endforeach; endif; ?>
                    </ul>
                </div>
            </div>
            <div id="con_m">
                <div id="title">
                    您的位置：首页<span>></span>信息公开目录<span>></span><span class="art_title"><?php echo ($firstArt["art_title"]); ?></span>
                </div>
                <div id="passage">
                    <h1><?php echo ($firstArt["art_title"]); ?></h2>
                    <div class="contents">
